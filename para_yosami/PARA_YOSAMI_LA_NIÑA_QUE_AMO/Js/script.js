...
fetch('Img/treelove.svg')
  ...
  .then(svgText => {
    ...
    const heartPaths = allPaths.filter(el => {
      ...
      return style.includes('#000000') || style.includes('#000000');
    });
...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi futura esposita DANNA YOSAMI:\n\n nunca he hecho una carta asi que esta es la primera y quiero empezar diciendote lo mucho que amo todo de ti tu personalidad muy amable, empatica, una persona increible en todos los sentidos amo cuando jugamos,cuando hablamos aunque no hagamos nada simplemente soy muy feliz tanto que con solo escuchar tu nombre o leerlo me hace muy feliz amo tus virtudes como sabes matematicas, leer, jugar pro gamer como yo, dibujar, saber decorar, cocinar, amo cuando te enojas y despues me perdones\n\n y lo que mas amo de ti es tu personalidad rara pero a la ves unica me gusta mucho y tu mirada de muchos amigos todo eso amo de ti y fisicamente me gustas todo de ti yosami cuando sonries aunque luego te tapes la cara tu cara tambien me gusta mucho tu color de piel tus facciones femeninas tu estatura aunque tal ves a ti no te guste pero para mi tu asi eres perfecta eres una chica muy hermosa y eres una mujer muy increible yosami y me enamore perdidamente de ti `;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "De Gonzalo";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-12-23T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-12-23T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `DESDE LO QUE DIJIMOS ESA NOCHE: <b>${days}</b> días<br>` +
      `LO QUE FALTA PARA QUE VUELVA ESA FECHA : <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
